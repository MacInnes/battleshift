...
describe "Api::V1::Shots" do
  context "POST /api/v1/games/:id/shots" do
    ...
    let(:player_1) { User.new(api_key: ENV["BATTLESHIFT_API_KEY"], email: ENV["BATTLESHIFT_EMAIL"]) }
    let(:player_2) { User.new(api_key: ENV["BATTLESHIFT_OPPONENT_API_KEY"], email: ENV["BATTLESHIFT_OPPONENT_EMAIL"]) }
